  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-100 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100">
      ...
      <aside className="flex w-56 flex-shrink-0 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 z-20">
        ...
        {/* Primary Navigation */}
        <nav className="flex-1 space-y-1 p-2 text-xs font-medium text-slate-600 dark:text-slate-400">
          ...
          <Link
            href="/pos/new-bill"
            className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-left font-semibold transition ${
              isPos
          ...
          >
            ...
            <span className="rounded bg-slate-200/70 dark:bg-slate-800 px-1.5 py-0.5 text-[9px] font-mono text-slate-600 dark:text-slate-400">
              F1
            </span>
          </Link>
          ...
          <button
            type="button"
            disabled
            className="flex w-full items-center justify-between rounded-md px-3 py-2 text-slate-400 dark:text-slate-600 cursor-not-allowed opacity-60"
          >
            <div className="flex items-center gap-2">
              <ClipboardList className="h-4 w-4" />
              <span>Lab Orders</span>
            </div>
            <span className="text-[9px] text-slate-400 italic">Soon</span>
          </button>
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-2.5">
          ...
          <div className="mt-1.5 grid grid-cols-2 gap-1 text-[11px] font-mono text-slate-600 dark:text-slate-400">
        ...
        <header className="flex h-14 items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 shrink-0 z-10">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800/90 p-1 rounded-lg border border-slate-200 dark:border-slate-700/60">
            ...
            >
              ...
              <span>Billing (POS)</span>
              <span className="text-[10px] font-mono opacity-60">F1</span>
            </Link>
            ...
            >
              ...
              <span className="text-[10px] font-mono opacity-60">F3</span>
            </Link>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex text-xs text-slate-500 dark:text-slate-400 font-mono items-center gap-1">
